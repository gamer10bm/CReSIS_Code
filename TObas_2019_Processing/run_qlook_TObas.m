...
for did = 4%2:length(daysegs)
  params = ct_set_params(params,'cmd.qlook',1,'day_seg',daysegs{did});
end
% params = ct_set_params(params,'cmd.qlook',1,'day_seg','20190204_03');
params = ct_set_params(params,'cmd.frms',[]);

% QLOOK
% params = ct_set_params(params,'radar.wfs(1).coh_noise_method','');
% params = ct_set_params(params,'radar.wfs(2).coh_noise_method','');
% params = ct_set_params(params,'radar.wfs(1).deconv.en',false);
% params = ct_set_params(params,'radar.wfs(2).deconv.en',false);
