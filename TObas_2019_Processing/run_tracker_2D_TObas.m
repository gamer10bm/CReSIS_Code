...
options.layer_dest_echogram_source  = 'standard';   % Only required if layerData files do not exist and need to be created
...
options.viterbi.crossoverload  = false;
options.viterbi.layername      = 'bottom';
...
options.viterbi.bottom_bin    = 1500;%-1;
