...
if strcmpi(data_load_method,'picker')
  ...
  param.start.picker = '20210225_01_061: 44.192365 N, -103.782817 E, X:54.199 km, Y:163.104 km, 2021-02-25 15:05:27.100'; % <== CHANGE HERE
  param.stop.picker = '20210225_01_062: 44.223903 N, -103.787971 E, X:54.195 km, Y:163.135 km, 2021-02-25 15:06:40.29'; % <== CHANGE HERE
...
param.season_name = '2020_SouthDakota_N1KU'; % <== CHANGE HERE
...
param.out = 'qlook_noise_deconv'; % <== CHANGE HERE
...
if echo_param.elev_comp == 3
  echo_param.depth = '[min(Surface_Elev)-10 max(Surface_Elev)+10]'; % <== CHANGE HERE
  %echo_param.depth = '[1594.9 1635.1]';
else
  echo_param.depth = '[min(Surface_Depth)-2.5 max(Surface_Depth) +2.5]'; % <== CHANGE HERE
...
param.post.map.location = 'SouthDakota';
