...
% param_fns = {ct_filename_param('rds_param_2018_Antarctica_Ground.xls')};
param_fns = {ct_filename_param('snow_param_2020_SouthDakota_N1KU.xls')};
...
label = [];
label.day_seg = {'20210219_04','20210219_01','20210225_01'}; %
label.frm = {[32],[42],[61]}; %
label.text = {'Lake 02/19','Wyoming 02/19','Snotel 02/25'}; %
