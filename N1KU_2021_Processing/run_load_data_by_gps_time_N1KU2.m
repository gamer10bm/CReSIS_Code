...
if strcmpi(data_load_method,'picker')
  ...
  param.start.picker = '20210220_03_066: 44.013974 N, -103.816680 E, X:54.175 km, Y:162.927 km, 2021-02-20 18:11:20.96'; % <== CHANGE HERE
  param.stop.picker = '20210220_03_067: 44.026662 N, -103.785435 E, X:54.197 km, Y:162.940 km, 2021-02-20 18:12:15.65'; % <== CHANGE HERE
...
if echo_param.elev_comp == 3
  ...
  echo_param.depth = '[min(Surface_Depth)-5 max(Surface_Depth) +5]'; % <== CHANGE HERE
