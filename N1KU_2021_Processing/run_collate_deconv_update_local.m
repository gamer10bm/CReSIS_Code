...
params = ct_set_params(params,'cmd.generic',1,'day_seg','20210328');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20210218_01');
...
param_override.collate_deconv_update.cmd{end}.day_seg = {'20210205_01'};
