...
if strcmpi(data_load_method,'picker')
  ...
  param.start.picker = '20210219_04_032: 44.077627 N, -103.512050 E, X:54.391 km, Y:162.990 km, 2021-02-19 21:00:11.95'; % <== CHANGE HERE
  param.stop.picker = '20210219_04_033: 44.075177 N, -103.491773 E, X:54.406 km, Y:162.988 km, 2021-02-19 21:00:44.72'; % <== CHANGE HERE
...
if echo_param.elev_comp == 3
  echo_param.depth = '[min(Surface_Elev)-2 max(Surface_Elev)+2]'; % <== CHANGE HERE
  %echo_param.depth = '[1594.9 1635.1]';
else
  echo_param.depth = '[min(Surface_Depth)-1 max(Surface_Depth) +1]'; % <== CHANGE HERE
