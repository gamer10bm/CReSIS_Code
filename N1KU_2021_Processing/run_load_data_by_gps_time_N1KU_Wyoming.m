...
if strcmpi(data_load_method,'picker')
  ...
  param.start.picker = '20210219_01_042: 44.060568 N, -104.096778 E, X:53.976 km, Y:162.973 km, 2021-02-19 15:02:46.54'; % <== CHANGE HERE
  param.stop.picker = '20210219_01_043: 44.074456 N, -104.111667 E, X:53.965 km, Y:162.987 km, 2021-02-19 15:03:28.32'; % <== CHANGE HERE
...
if echo_param.elev_comp == 3
  ...
  echo_param.depth = '[min(Surface_Depth)-2 max(Surface_Depth) +2]'; % <== CHANGE HERE
